...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $form_data = [
        ...
        'traffic_source_id' => htmlspecialchars($_POST['traffic_source_id_g']),
...
})(window,document,'script','dataLayer','GTM-N2X7FPHV');</script>
<!-- End Google Tag Manager -->
</head>
<body>
	
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N2X7FPHV"
    ...
    <div class="container">
        ...
        <form id="leadForm" action='' method='post'>
            ...
            <div class="form-content">
                ...
                <input type='hidden' value='9998' name='traffic_source_id_g'>
                ...
                <button type="button" id="submitButton" class="fe-insurance" onclick="submitForm()">Submit</button>
            </div>
        </form>
    </div>
...
<script>
    function submitForm() {
		...
		const fieldsToExclude = ['ip_region', 'ip_city', 'ip_country', 'traffic_source_id_g']; // Add other fields you want to exclude
